...
export function actorFixtures():ActorFixture[] {
  ...
  refreshFixtureBrief(wolf,"Cato is my known pack ally. We are both unexposed. Briar (p2), a villager, is credibly suspected and eliminating them reaches parity for our pack. Voting for Briar is my current plan; exposing Cato would sacrifice our advantage.");
